...
result, joint_one_handle = vrep.simxGetObjectHandle(clientID, 'Sawyer_joint7', vrep.simx_opmode_blocking)
...
dtheta = float(input('Please enter a value joint 3 \n')) #desired theta
vrep.simxSetJointTargetPosition(clientID, joint_one_handle, theta+dtheta, vrep.simx_opmode_oneshot)
